  ...
  <body>
    <div class="py-md-5 py-4 border-bottom">
    	<div class="container">
          ...
          $id_dent=$_GET['id'];
          $req="select id_user from user where id_user=$id_dent";
          $res=mysql_query($req) or die ("echec");
          echo"<center><a href='http://127.0.0.1/projet_2020/dentiste/index.php?id=$id_dent'> <img src='logo.png' width='60' height='60'></a> </center>";
		    		echo"<a class='navbar-brand' href='http://127.0.0.1/projet_2020/dentiste/index.php?id=$id_dent'>Dentista<span>Dental Clinic</span></a>";?>
	    		</div>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Profil (edit)</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href='http://127.0.0.1/projet_2020/dentiste/index.php<?php echo"?id=$id_dent";?>'>Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"></span> <span>Profil(Edit) <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
		...
		<section class="ftco-section">
          ...
          echo"
          <form name='f' action='ajout.php?id=$id_dent' method='post' enctype='multipart/form-data'>";?>
            <input type="hidden" value="1000000" name="MAX_FILE_FILE" />
           ...
           <div class="comment-form-wrap pt-5">
                ...
                <?php
                  ...
                  $res=mysql_query($req) or die ("echec");
                  $s=mysql_fetch_array($res);
                echo"<input type='hidden' name='iduser' value='$s[0]'>";?>
                  ...
                  while($s=mysql_fetch_array($res)){
                    echo"<option selected value='$s[0]'>$s[1] ║ $s[2] ║ $s[5]</option>";
                  }
                 ?>
                  </select>
                  </div>
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
            	<h3>Category</h3>
              <ul class="categories">
                <li><a href="#">Neurolgy <span>(+)</span></a></li>
