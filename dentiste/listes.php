      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href='http://127.0.0.1/projet_2020/dentiste/index1.php<?php echo"?id=$s1[0]";?>'>Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"></span> <span>La liste<i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section">
      ...
      <div class="col-lg-8 ftco-animate">
       ...
       <div class="comment-form-wrap pt-5">
          ...
          <form name="f" action='supprimeliste.php<?php echo"?id=$id_dent";?>' method="post">
