	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <p class='mb-0'><a href='<?php echo"reclamation.php?id=$id_dent";?>' class='btn btn-primary'>Reclamation <svg width='1em' height='1em' viewBox='0 0 16 16' class='bi bi-exclamation-octagon-fill' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
         ...
         <li class="nav-item"><p href='' class="nav-link"></p></li>
            ...
            <li class="nav-item"><a href='cabinet.php<?php echo"?id=$s1[0]";?>' class="nav-link">Cabinet</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Modifier profil</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href='http://127.0.0.1/projet_2020/dentiste/index1.php<?php echo"?id=$s1[0]";?>'>Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"></span> <span>Profil <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
		...
		<section class="ftco-section">
          ...
          <div class="col-lg-8 ftco-animate">
           ...
           <div class="comment-form-wrap pt-5">
              ...
              mysql_select_db("dent");
              $id=$_GET['id_profil'];
              $req="select* from dentiste where id_dent='$id'";
              $res=mysql_query($req) or die("echec".mysql_error());
              $s=mysql_fetch_array($res);
              echo"<form name='f' action='valide.php?id=$id_dent&&id_profil=$id' method=post>";?>
              
              <input type="hidden" name="idprofil" value="<?php echo $s[0];?>">
              <div class="form-group">
               <input Type="file" name="f" value="<?php echo $s['14'];?>">(Choisir un photo)
                 </div>
                 <div class="form-group">
               <input Type="text" class="form-control"  name="nom" value="<?php echo $s['1'];?>">
                 </div>
                 <div class="form-group">
               <input Type="text" name="prenom"class="form-control" value="<?php echo $s['2'];?>">
                 </div>
                 <div class="form-group">
                   
                   <select class="form-control" name="cabinet">
                    <option selected value="<?php echo $s[3];?>"><?php echo $s[3];?></option>
                 </select>
                 </div>
                 <div class="form-group">
               <input Type="text" name="adresse"class="form-control" value="<?php echo $s['4'];?>">
                 </div>
                 <div class="form-group">
               <input Type="number" name="num"class="form-control" value="<?php echo $s['5'];?>">
                 </div>
                 <div class="form-group">
                  <textarea name="bio" cols="30" rows="7" class="form-control"  ><?php echo $s['6'];?></textarea>
                   </div>
                   <!-- single accordian area -->
                    ...
                    <div class="panel single-accordion">
                            ...
                            <h5>
                                <a role="button" class="collapsed" aria-expanded="true" aria-controls="collapseTwo" data-parent="#accordion" data-toggle="collapse" href="#collapseTwo" border="1">Spécialités ► 
                                        <span class="accor-open"><i class="fa fa-plus" aria-hidden="true"></i></span>
                                        <span class="accor-close"><i class="fa fa-minus" aria-hidden="true"></i></span>
                                        </a>
                            </h5>
                            <div id="collapseTwo" class="accordion-content collapse">
                            •Orthodontie <input type="checkbox"  name="sp" value="orthodontie"> <br> •Chirurgie Orale <input type="checkbox" name="sp1" value="chirurgir_orale"><br> •Parodontologie <input type="checkbox" name="sp2" value="parodontologie"><br> •Chirurgie maxillo-faciale <input type="checkbox" name="sp3" value="chirurgie_maxillo_faciale"><br> 
                   •Médecine interne bucco-dentaire <input type="checkbox"  name="sp4" value="medecine_interne_bucco_dentaire"><br> •Pédodontie <input type="checkbox"  name="sp5" value="pedodontie"><br> •Prothèse dentaire <input type="checkbox"  name="sp6" value="prothese_dentaire"><br>  
                            </div>
                        </div></div><br>
                        <!-- single accordian area -->
