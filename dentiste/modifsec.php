  ...
  <div class="py-md-5 py-4 border-bottom">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
         ...
         <li class="nav-item"><p href='' class="nav-link"></p></li>
         <li class="nav-item"><p href='' class="nav-link"></p></li>
            <li class="nav-item "><a href='index1.php<?php echo"?id=$s1[0]&&id_profil=$s3[0]";?>' class="nav-link">Profil</a></li>
            <?php
            mysql_connect("localhost","root","");
            mysql_select_db("dent");
            $id_dent=$_GET['id'];
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Secretaire</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href='http://127.0.0.1/projet_2020/dentiste/index1.php<?php echo"?id=$s1[0]";?>'>Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"></span> <span>Secretaire <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section">
          ...
          <div class="col-lg-8 ftco-animate">
           ...
           <div class="comment-form-wrap pt-5">
                <h3 class="mb-5 h4 font-weight-bold">Modifier secretaire</h3>
                <?php
              mysql_connect("localhost","root","");
              mysql_select_db("dent");
              $id_dent=$_GET['id'];
              $req="select * from secretaire where dentiste='$id_dent'";
              $res=mysql_query($req) or die("echec".mysql_error());
              $s=mysql_fetch_array($res);

              echo"<form name='f' action='validsec.php?id=$id_dent' method='post'>";
              echo'<img src="data:image/jpeg;base64,'.base64_encode($s['lien']).'" width="300" height="300"></td></tr>';
              echo"<hr>";?>
                <input type="hidden" name="idsec" value="<?php echo $s[0];?>"> 
                <div class="form-group">
                 ...
                 <div class="form-group">
                   ...
                   <input type="text" class="form-control" name="prenom"  value="<?php echo $s[2];?>">
                 </div>
                 <div class="form-group">
                    
                    <select class="form-control" name="dentiste">
                  ...
                  $res=mysql_query($req) or die ("echec");
                  $s1=mysql_fetch_array($res);
                    echo"<option selected value='$s1[0]'>$s1[0] ║ $s1[1] ║ $s1[2]</option>";
                 ...
                 <div class="form-group">
                   ...
                   <input type="text" class="form-control" name="adresse"  value="<?php echo $s[4];?>">
                 </div>
                 <div class="form-group">
                 ...
                 <div class="form-group">
                   ...
                   <input type="text" class="form-control" name="login"  value="<?php echo $s[6];?>">
                 </div>
                 <div class="form-group">
                   
                   <input type="text" class="form-control" name="password"  value="<?php echo $s[7];?>">
                 </div>
                 <div class="form-group">
                   
                 <textarea name="bio" cols="30" rows="7" class="form-control"  value=""><?php echo $s[8];?></textarea>
                 </div>
                </div>
              ...
              $req="select * from secretaire where dentiste=$id_dent";
              $res=mysql_query($req) or die ("echec");
              $s2=mysql_fetch_array($res);
             echo"<form name='f' action='validsec.php?id_sec=$s2[0]&&id=$id_dent' method='post'>
              <div class='form-group'>
                    <input type='submit' value='Enregistrer' class='btn py-3 px-4 btn-primary'>
                    <a href='http://127.0.0.1/projet_2020/dentiste/profilsec.php?id=$id_dent' class='btn py-3 px-4 btn-secondary'>Retour</a>
                      </div>   
              </form>"
              ?>
            </div>
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
            	<h3>Category</h3>
              <ul class="categories">
                <li><a href="listes.php">Les listes<span>(+)</span></a></li>
