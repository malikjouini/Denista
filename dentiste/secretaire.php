...
<html lang="en">
  ...
  <div class="py-md-5 py-4 border-bottom">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
         ...
         <li class="nav-item"><p href='' class="nav-link"></p></li>
            ...
            <li class="nav-item active"><a href='http://127.0.0.1/projet_2020/dentiste/secretaire.php<?php echo"?id=$s1[0]";?>' class="nav-link">Sécretaire</a></li>
    ...
    <div class="container">
          ...
          <form name="f" action='ajoutsec.php<?php echo"?id=$s1[0]";?>' method="post" enctype="multipart/form-data">
           ...
           <div class="comment-form-wrap pt-5">
                <h3 class="mb-5 h4 font-weight-bold">Intro</h3>
                  ...
                  $s=mysql_fetch_array($res);
                    echo"<option selected value='$s[0]'>$s[0] ║ $s[1] ║ $s[2]</option>";
