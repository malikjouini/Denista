	...
	<section class="ftco-section">
          ...
          <div class="col-lg-8 ftco-animate">
           ...
           <div class="comment-form-wrap pt-5">
                <h3 class="mb-5 h4 font-weight-bold">Cabinet</h3>
                <?php
              mysql_connect("localhost","root","");
              mysql_select_db("dent");
              $id_dent=$_GET['id'];
              ...
              echo'<img src="data:image/jpeg;base64,'.base64_encode($s['lien']).'" width="300" height="300"></td></tr><br>';
              echo"<hr>";
                      echo "<table>
                      <tr>
                      <td><font color='#46b7de'>Nom de Cabinet :</font></td>
                     <td>$s[1]</td>
                     </tr>
                     <tr>
                  ...
                  <tr>
                    <td><font color='#46b7de'>Horaire d'ouverture :</font></td>
                    <td>$s[3]</td>
                    </tr>
                  <tr>
                    <td><font color='#46b7de'>Horaire de fermeture :</font></td>
                    <td>$s[4]</td>
                    </tr>
                  <tr>
                    <td><font color='#46b7de'>Numero Fix :</font></td>
                    <td>$s[5]</td>
                    </tr>
                    </table>
                  <tr>
                    <td><font color='#46b7de'>Bio :</font></td></tr>
                    <table>
                    <tr>
                    <td>$s[6]</td>
                    </tr>
             ...
             echo"<form name='f' action='modifcab.php?id=$id_dent&&?idcab=$s[0]' method='post'>
              <div class='form-group'>
