          ...
          <div class="col-lg-8 ftco-animate">
           ...
           <div class="comment-form-wrap pt-5">
              ...
              echo"<hr>";
                      echo"<table>
                      <tr>
                      <td><font color='#46b7de'>Nom :</font></td>
                      <td></td>
                     <td>$s[1]</td>
                     </tr>
                  
                  <tr>
                    <td><font color='#46b7de'>Prénom :</font></td> 
                    <td></td>
                    <td>$s[2]</td>
                    </tr>
                  
                  <tr>
                    <td><font color='#46b7de'>Dentiste :</font></td>
                    <td></td>
                    <td>$s[3]</td>
                    </tr>
                  
                  <tr>
                    <td><font color='#46b7de'>Adresse :</font></td>
                    <td></td>
                    <td>$s[4]</td>
                    </tr>
                  <tr>
                    <td><font color='#46b7de'>Numéro :</font></td>
                    <td></td>
                    <td>$s[5]</td>
                    </tr>
                  <tr>
                    <td><font color='#46b7de'>bio :</font></td>
                    <td></td>
                    <td>$s[8]</td>
                    </tr>
                </table>";
             ...
             echo"<form name='f' action='modifsec.php?id_sec=$s2[0]&&id=$id_dent' method='post'>
              <div class='form-group'>
                    <input type='submit' value='Modifer' class='btn py-3 px-4 btn-primary'>
                    <a href='supprimesec.php?id_sec=$s2[0]&&id=$id_dent' class='btn py-3 px-4 btn-danger'>supprimer</a>
                      </div>   
              </form>"
              ?>
            </div>
