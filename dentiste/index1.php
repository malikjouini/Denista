		...
		<section class="ftco-section">
          ...
          <div class="col-lg-8 ftco-animate">
           ...
           <div class="comment-form-wrap pt-5">
              ...
              mysql_select_db("dent");
              $id_dent=$_GET['id'];
              $req="select* from dentiste where id_user=$id_dent";
              ...
              echo"<hr>";
                  ...
                  <tr>
                    <td><font color='#46b7de'>Cabinet :</font></td>
                    <td>$s[3]</td>
                    </tr>
                  ...
                  <tr>
                    <td><font color='#46b7de'>Numéro Fixe :</font></td>
                    <td>$s[5]</td>
                    </tr>
                  <tr>
                    ...
                    <div class='panel single-accordion'>
                            ...
                            $s[7] <br> $s[8]<br> $s[9]<br> $s[10]<br> 
                   $s[11]<br> $s[12]<br> $s[13]<br>  
                            </div>
                        </div></div><br>
                        <!-- single accordian area --></td></tr>
                        </table>";
             ...
             echo"<form name='f' action='modif.php?id=$id_dent&&id_profil=$s2[0]' method='post'>
              <div class='form-group'>
