	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
         ...
         <li class="nav-item"><p href='' class="nav-link"></p></li>
            ...
            <li class="nav-item "><a href='listes.php<?php echo"?id=$s1[0]&&id_dent=$s2[0]";?>' class="nav-link">La liste</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="http://127.0.0.1/projet_2020/index1.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"></span> <span>Profil <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-lg-8 ftco-animate">
           ...
           <div class="comment-form-wrap pt-5">
              ...
              $s=mysql_fetch_array($res);
                ...
                echo"<form name='f' action='valide.php?id=$id_sec' method='post'>";?>
                <div class="form-group">
                <input type="hidden" name="id" value="<?php echo $s[0];?>">
                <div class="form-group">
                <input type="file" name="f" value="<?php echo $s[9];?>">
                </div>
                   <input type="text" class="form-control" name="name" value="<?php echo $s[1];?>">
                 </div>
                 <div class="form-group">
                 ...
                 <div class="form-group">
                   ...
                   <input type="number" class="form-control" name="num"  value="<?php echo $s[5];?>">
                 </div>
                 <div class="form-group">
                   
                 <textarea name="bio" cols="30" rows="7" class="form-control"><?php echo $s[8];?></textarea>
                 </div>
