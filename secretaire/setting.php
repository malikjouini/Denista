      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href='http://127.0.0.1/projet_2020/secretaire/index1.php<?php echo"?id=$s1[0]";?>'>Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"></span> <span>Setting <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
		...
		<section class="ftco-section">
          ...
          <div class="col-lg-8 ftco-animate">
           ...
           <div class="comment-form-wrap pt-5">
                <h3 class="mb-5 h4 font-weight-bold">sécurité</h3>
                <div class="form-group">
                <?php
                mysql_connect("localhost","root","");
                mysql_select_db("dent");
                ...
                echo"<form name='f' action='modiflog.php?id=$id_sec' method='post'>";?>
                ...
                <h5> <span class="text" >Login :</span></h5>
                 ...
                 <br>
                 <form name='f' action='modifmdp.php<?php echo"?id=$id_sec";?>' method='post'>
                 <h5> <span class="text" >Password :</span></h5>
                  <input type="password" class="form-control" name="password" placeholder="Mot de passe actuel">
                 </div>
                 <div class="form-group">
                   
                   <input type="password" class="form-control" name="nvpassword" placeholder="Nouveau mot de passe">
                   <br>
                   <input type="submit" value="Modifier" class="btn py-3 px-4 btn-primary">
