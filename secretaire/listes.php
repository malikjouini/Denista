...
<html lang="en">
  ...
  <div class="py-md-5 py-4 border-bottom">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        echo"<p class='mb-0'><a href='accepter.php?id=$s1[0]&&id_dent=$s2[0]' class='btn btn-primary'>Accepter <span class='ion-ios-arrow-round-forward'></span></a></p>
        ";?> 
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">La liste de Rendez vous</h1>
...
$req="select* from rendez_vous R,cabinet C where C.id_cab=R.id_cab and C.id_dent=$id_dent and R.etat='en attente'";
$res=mysql_query($req) or die ("echec");
while($s=mysql_fetch_array($res))
{
  ...
  <tbody>
    ...
    <td>$s[5]</td>
    <td>$s[6]</td> 
<td><a href='accept.php?id=$s[0]&&id_sec=$id_sec&&id_dent=$id_dent' class='btn btn-success'>accepter</a></td> 
<td><a href='supprime.php?id=$s[0]&&id_sec=$id_sec&&id_dent=$id_dent' class='btn btn-danger'>supprimer</a></td> 
</tr>
</tbody>";}
?>
</table>
          ...
          <form name="f" action='supprimeliste.php<?php echo"?id=$id_sec&&id_dent=$id_dent";?>' method="post">
