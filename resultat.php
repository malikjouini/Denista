...
$n=mysql_num_rows($res3);
		  ...
		  echo"
              ...
              <li class='nav-item active'><a href='resultat.php?id_pat=$id_pat' class='nav-link'>Resultat</a></li>
					  </ul>
					</div>
				</div>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Resultat</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index1.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Resultat <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-9">
                        ...
                        mysql_select_db("dent");
                        $id_pat=$_GET['id_pat'];
                        $req="select* from rendez_vous where id_pat='$id_pat'";
                        ...
                        $req2="select* from patient where id_pat='$id_pat'";
		                    ...
		                    $s2=mysql_fetch_array($res2);
                        if($n==1)
                        echo"Mr(s). <font color='black'>$s[1] $s[2]</font> le propriétaire de l'email <font color='black'>$s[3]</font>
                         et de numéro téléphone <font color='black'>$s[6]</font><br> vous avez un rendez-vous de <font color='black'>$s[4]</font>
                          à <font color='black'>$s[5]</font>
                        
                        
            <p></p>
            <br><small>vous devez annuler votre ancienne rendez-vous pour faire une autre rendez-vous</small>
					</div>
					<div class='col-md-3 d-flex align-items-center'>
            <p class='mb-0'><span class='btn btn-secondary px-4 py-3'>$s[9]</span></p>
            <p class='mb-0'><a href='annulerrdv.php?id_pat=$id_pat'  class='btn btn-danger px-4 py-3'>Annuler</a></p>";
            
            else
                       { 
                         echo"désolé vous n'avez pas de rendez-vous allez chez <a href='index1.php?id_pat=$id_pat' class='btn btn-outline-dark'>HOME</a> et choisissez votre dentiste";
                       }
                       ?>
					</div>
				</div>
