        ...
        echo"
                <div class='collapse navbar-collapse' id='ftco-nav'>
                  <ul class='navbar-nav m-auto'>
                    ...
                    <li class='nav-item active'><a href='contact.php?id_pat=$id_pat' class='nav-link'>Reclamation</a></li>
                  </ul>
                </div>
              </div>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index1.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Contact <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb contact-section">
          ...
          $res2=mysql_query($req2) or die ("echec");
          $s2=mysql_fetch_array($res2);
           echo"<form action='ajoutcontact.php?id_pat=$id_pat' name='f' method='post'>
           <input type='hidden' name='idutil' value='$s2[0]'>";?>
