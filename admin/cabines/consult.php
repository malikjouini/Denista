      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Consulte le cabinet</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="http://127.0.0.1/projet_2020/admin/cabines/index.php">Retour <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"></span> <span>Consulte <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section><br>
...
echo'<img src="data:image/jpeg;base64,'.base64_encode($s['lien']).'" width="500" height="400"><br>';
echo"<br>";
...
<a href='http://127.0.0.1/projet_2020/admin/cabines/index.php' class='btn btn-info'>Retour</a>";
?>
</div></div>
</div></div>
</div>
