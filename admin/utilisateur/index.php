...
<section class="hero-wrap hero-wrap-2" style="background-image: url('images/bg_1.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">La liste des utilisateurs</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="http://127.0.0.1/projet_2020/admin/">Admin <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"></span> <span>utilisateur<i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section><br>
    ...
    <div class="container">
        ...
        <div class="col-lg-9 ftco-animate">
         ...
         <a href="http://127.0.0.1/projet_2020/admin/utilisateur/ajout.html" class="btn btn-success btn-sm">Ajouter</a>
              <h2 class="mb-5 h4 font-weight-bold">Les utilisateurs</h2>
