    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
          ...
          <p class="breadcrumbs"><span class="mr-2"><a href="http://127.0.0.1/projet_2020/admin/contact/index.php">retour <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"></span> <span>reclamation <i class="ion-ios-arrow-forward"></i></span></p>
        </div>
      </div>
    </div>
  </section>
<center>
          ...
          <div class="col-lg-8 ftco-animate">
           ...
           <div class="comment-form-wrap pt-5">
                <h2 class="mb-5 h4 font-weight-bold mx-5">Reclamation</h2>
                <?php
              ...
              echo "<table> 
              <tr>
              <td><b><font color='#46b7de'>ID :</font></b></td>
              <td>$s[0]</td></tr>
              </tr><td><b><font color='#46b7de'>NOM :</font></b></td>
              <td>$s[1]</td></tr>
              <tr><td><b><font color='#46b7de'>USER :</font></b></td>
              <td>$s[2]</td></tr>
              <tr><td><b><font color='#46b7de'>EMAIL :</font></b></td>
              <td>$s[3]</td></tr>
              <tr><td><b><font color='#46b7de'>SUBJECT :</font></b></td>
              <td>$s[4]</td></tr>
              <tr><td><b><font color='#46b7de'>MESSAGE :</font></b></td>
              <td class='text-break'>$s[5]</td></tr>
              </table>";
              echo"<br>
              <form name='f' action='supprimemsg.php?id=$s[0]' method='post'>
              <div class='form-group'>
                    <input type='submit' value='Supprimer' class='btn py-3 px-4 btn-primary'>
                  </div>";
             ?>
