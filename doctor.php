		  ...
		  echo"
					<div class='collapse navbar-collapse' id='ftco-nav'>
					  <ul class='navbar-nav m-auto'>
						  ...
						  <li class='nav-item active'><a href='doctor.php?id_pat=$id_pat' class='nav-link'>Doctor</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index1.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Doctors <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-lg-3 ftco-animate">
		                ...
		                <li class="ftco-animate"><a href="https://www.facebook.com/" class="d-flex align-items-center justify-content-center"><span class="icon-facebook"></span></a></li>
