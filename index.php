    ...
    <div class="py-md-5 py-4 border-bottom">
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-start align-items-center px-3 px-md-0">
				...
				<center><a href="http://127.0.0.1/projet_2020/"> <img src="logo.png" width="60" height="60"></a> </center>
		    		<a class="navbar-brand" href="http://127.0.0.1/projet_2020/index.php">Dentista<span>Dental Clinic</span></a>
	    		</div>
			    ...
			    <div class="col-md-4 order-md-3 d-flex topper mb-md-0 align-items-center">
					...
					<div class="pr-md-4 pl-md-0 pl-3 text">
					    <p class="con"><span>Free Call</span> <span>+21651006092</span></p>
					    <p class="con">Ariana safsaf</p>
				    </div>
			    </div>
		    </div>
		  </div>
  ...
  <form name="f" action="verif.php" method="post">
    <div class="login-wrap">
    	<div class="login-html">
    		...
    		<input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab">PATIENT REGISTRATION</label>
    		<div class="login-form">
    			<div class="sign-in-htm">
    				...
    				<div class="hr"></div>
    				<div class="foot-lnk">
    					<label class="phr "for="#">Forgot Password?</label>
    				</div>
    			</div>
    			</form>
    			...
    			<div class="sign-up-htm">
                    ...
                    <div class="group">
                        ...
                        <input name="prenom" type="text" class="input" required>
                    </div>
    				<div class="group">
    					<label for="login" class="label">Login</label >
    					<input name="login" type="text" class="input" required>
    				...
    				<div class="group">
    					<label for="number" class="label">Number phone</label >
    					<input name="number" type="number" class="input" required>
    				</div>
    				...
    				<div class="hr"></div>
    				<div class="foot-lnk">
    					<label for="tab-1"class="phr">Already Member?</label>
    				</div>
    			</div>
    		</div>
    	</div>
			  ...
			  <div class="ftco-footer-widget mb-5">
				  ...
				  <div class="block-23 mb-3">
					<ul>
					  ...
					  <li><a href="#"><span class="icon icon-envelope"></span><span class="text">malekjouini47@gmail.com</span></a></li>
					</ul>
				  </div>
